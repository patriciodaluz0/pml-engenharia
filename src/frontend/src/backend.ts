...
import type { Article as _Article, Cell as _Cell, Error as _Error, Message as _Message, MessageId as _MessageId, MessageStatus as _MessageStatus, MessageSummary as _MessageSummary, MessageType as _MessageType, Product as _Product, ProductCategory as _ProductCategory, ProductId as _ProductId, ProductSummary as _ProductSummary, Project as _Project, Result as _Result, Result__1 as _Result__1, UserRole as _UserRole, Value as _Value } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getProjectBySlug(arg0: string): Promise<Project | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getProjectBySlug(arg0);
    ...
    async listArticles(): Promise<Array<ArticleSummary>> {
        if (this.processError) {
            try {
    ...
    async listMessages(): Promise<Array<MessageSummary>> {
        if (this.processError) {
            try {
    ...
    async listProducts(): Promise<Array<ProductSummary>> {
        if (this.processError) {
            try {
    ...
    async submitMessage(arg0: string, arg1: string, arg2: string | null, arg3: string, arg4: string, arg5: MessageType): Promise<MessageId> {
        if (this.processError) {
            try {
                const result = await this.actor.submitMessage(arg0, arg1, to_candid_opt_n37(this._uploadFile, this._downloadFile, arg2), arg3, arg4, to_candid_MessageType_n38(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMessageStatus(arg0: MessageId, arg1: MessageStatus): Promise<Message | null> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMessageStatus(arg0, to_candid_MessageStatus_n40(this._uploadFile, this._downloadFile, arg1));
                return from_candid_opt_n18(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_MessageSummary_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MessageSummary): MessageSummary {
    return from_candid_record_n34(_uploadFile, _downloadFile, value);
}
function from_candid_MessageType_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MessageType): MessageType {
...
function from_candid_ProductSummary_n36(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProductSummary): ProductSummary {
...
function from_candid_opt_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Article]): Article | null {
...
function from_candid_opt_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Product]): Product | null {
    return value.length === 0 ? null : from_candid_Product_n27(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        email: value.email,
        messageType: from_candid_MessageType_n23(_uploadFile, _downloadFile, value.messageType),
        company: record_opt_to_undefined(from_candid_opt_n25(_uploadFile, _downloadFile, value.company))
    };
}
...
function from_candid_variant_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "new" in value ? MessageStatus.new : "read" in value ? MessageStatus.read : "archived" in value ? MessageStatus.archived : value;
}
function from_candid_variant_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "contact" in value ? MessageType.contact : "b2bConsultancy" in value ? MessageType.b2bConsultancy : value;
}
function from_candid_variant_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "ebook" in value ? ProductCategory.ebook : "firmware" in value ? ProductCategory.firmware : "guide" in value ? ProductCategory.guide : "gerber" in value ? ProductCategory.gerber : value;
}
...
function from_candid_vec_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MessageSummary>): Array<MessageSummary> {
    return value.map((x)=>from_candid_MessageSummary_n33(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n35(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ProductSummary>): Array<ProductSummary> {
    return value.map((x)=>from_candid_ProductSummary_n36(_uploadFile, _downloadFile, x));
}
...
function to_candid_MessageStatus_n40(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MessageStatus): _MessageStatus {
    return to_candid_variant_n41(_uploadFile, _downloadFile, value);
}
function to_candid_MessageType_n38(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MessageType): _MessageType {
...
function to_candid_variant_n39(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MessageType): {
    contact: null;
} | {
    b2bConsultancy: null;
} {
    return value == MessageType.contact ? {
        contact: null
    } : value == MessageType.b2bConsultancy ? {
        b2bConsultancy: null
    } : value;
}
function to_candid_variant_n41(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MessageStatus): {
    new: null;
} | {
    read: null;
} | {
    ...
    return value == MessageStatus.new ? {
        new_: null
